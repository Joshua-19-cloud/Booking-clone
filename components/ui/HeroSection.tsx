...
export default function SearchBar() {
  return (
    <div className="absolute top-[350px] left-1/2 transform -translate-x-1/2 bg-white p-0 rounded-md shadow-md w-full max-w-6xl z-50 border-4 border-yellow-400">
