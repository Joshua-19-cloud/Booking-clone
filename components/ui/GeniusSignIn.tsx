...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className="bg-[#003580] px-6 sm:px-10 lg:px-20 py-2 sm:py-4 flex flex-col gap-1">
        {/* Top Right Actions */}
        <div className="w-full flex items-center justify-between px-4 sm:px-8 py-4 sm:justify-end gap-3">
      ...
      <div className="bg-[#003580] text-white h-auto sm:h-[35vh] px-4 sm:px-6 md:px-16 pt-3 relative">
        <div className="px-6 sm:px-12 lg:px-20 py-6 sm:py-8">
        ...
        <div className="left-0 w-full items-center -mt-3">
          <h3 className="text-2xl font-bold px-6 text-gray-900">Offers</h3>
          <p className="text-l text-gray-600 px-6 py-1">
        ...
        <div className="w-full items-center justify-between px-6 mt-14">
        ...
        {/* Destination Images */}
        <div className="flex flex-col sm:flex-row gap-4 px-4 sm:px-6 mt-10">
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-col gap-1 mt-2">
                      ...
                      <div className="mt-1 text-xs text-gray-800">
                        2 nights{" "}
                        <span className="line-through text-gray-500 ml-1">{item.originalPrice}</span>{" "}
