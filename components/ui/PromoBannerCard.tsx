...
export function PromoBannerCard({
  ...
  return (
    <div className="ml-[-10px] sm:ml-[-300px] px-4 w-full">
      <Card className="flex flex-col sm:flex-row justify-between items-center p-4 sm:p-4 w-full max-w-[540px] border border-gray-200 shadow-lg rounded-xl bg-white mx-auto">
