      ...
      <div className="max-w-7xl mx-auto relative">
        <nav>
          ...
          <ul className="flex sm:hidden flex-col relative">
            ...
            >
              <Link href={activeItem.href} className="flex items-center gap-2 w-full">
                <span className="w-6 h-6">{activeItem.icon}</span>
          ...
          {/* Desktop Navigation */}
          <ul className="hidden sm:flex sm:justify-center sm:flex-wrap sm:gap-3">
            {navItems.map((item, idx) => (
              <li
                key={idx}
