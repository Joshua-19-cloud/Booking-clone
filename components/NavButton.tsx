...
export default function NavButton() {
  return (
    <div className="w-full">
      <nav>
        {/*
          On mobile, this flex container will allow horizontal scrolling.
          On desktop (`sm:`), it will center the items and allow them to wrap.
        */}
        <ul
          className="
            flex gap-2 sm:gap-3
          ...
          {navItems.map((item, idx) => (
            <li
              ...
              className={`
                ...
                px-4 sm:px-6 py-2 sm:py-3 rounded-full shrink-0
                text-sm font-medium
                ${idx === 0
